# Generated by Django 5.1.7 on 2025-03-10 00:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correction_models', models.JSONField(default=list)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('role', models.CharField(choices=[('PROF', 'Professeur'), ('STUDENT', 'Étudiant')], default='STUDENT', max_length=10)),
        ...
        migrations.AddField(
            model_name='exercise',
            name='professor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exercises', to='core.user'),
        ),
    ]
